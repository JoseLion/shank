(function () {
  ...
  .directive('decimal', function() {
    ...
    var max = function() {return '99999999999999999999';};
    ...
    var selection_substitution_validation = function(input, value) {
      current_value = angular.element(input).val();
      var selection_start = angular.element(input)[0].selectionStart;
      var selection_end = angular.element(input)[0].selectionEnd;
    ...
    var link = function(scope, element) {
      ...
      angular.element(element).attr('autocomplete', 'off');
      
      angular.element(element).on('keydown', function(e){
        key = e.charCode || e.keyCode || 0;
        current_value = angular.element(element).val();
      ...
      angular.element(element).on('keypress', function(e){
        ...
        if(is_coma() && !has_dot() && (not_last_coma_position_possible || max_integers_but_no_max_number)) {
          angular.element(e.target).val(angular.element(e.target).val() + '.');
          return false;
        }
