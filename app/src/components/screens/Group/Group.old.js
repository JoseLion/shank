...
class GroupTabBar extends React.Component {
  ...
  render() { 
    let tabs = this.props.tabs.map((name, page) => {
      ...
      return (
        <TouchableOpacity key={name} style={{flex: 1, alignItems: 'center', justifyContent: 'center', paddingTop: '5%', paddingBottom: '5%', backgroundColor: bgColor}} onPress={() => {this.props.goToPage(page)}}>
    ...
    return (
      <View style={{flexDirection: 'row', justifyContent: 'space-around', borderBottomWidth: 1, borderTopWidth: 1, borderColor: '#B3BEC9'}}>
        {tabs}
  ...
  render() {
    ...
    return (
      <View style={[MainStyles.container]}>
        ...
        <View style={[LocalStyles.groupInformation, {paddingTop: '5%'}]}>
